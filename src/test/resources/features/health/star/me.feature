Feature: health feature testing
  ...
  Scenario Outline: Quotes page
    ...
    Examples:
      | product_id                                 |
      |S2QPZdU4u_IqWgPGPK8xg2R1VKhIKzV5-QU8fZYZxaM|
  ...
  Scenario Outline: Contact tab
    ...
    Examples:
      | address1 | address2  |pan_number  |email_id             | mobile_no |city_name|area_name|address_proof   |address_proof_number|otp    |
      | stanley  | hospital  |CWJPA6785N  |arunm@mailinator.com |8838517743 |Chennai  |Parrys   |Driving License |TN012019000276      | 2345  |
  ...
  Scenario Outline: Insured member tab
    ...
    When   User select the insured member occupation "<insured_member_occupation>"
    When   User clicks the next button in insured member tab
    Examples:
      | self_weight |self_feet|self_inch|insured_member_occupation|
      |  76         |  6      | 2       |PROFESSIONAL-ENGINEER|
